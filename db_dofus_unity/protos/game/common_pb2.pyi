...
class lda(_message.Message):
    __slots__ = ("erai", "sex", "look")
    ERAI_FIELD_NUMBER: _ClassVar[int]
    SEX_FIELD_NUMBER: _ClassVar[int]
    LOOK_FIELD_NUMBER: _ClassVar[int]
    erai: str
    sex: Gender
    look: EntityLook
    def __init__(self, erai: _Optional[str] = ..., sex: _Optional[_Union[Gender, str]] = ..., look: _Optional[_Union[EntityLook, _Mapping]] = ...) -> None: ...

class ldb(_message.Message):
    __slots__ = ("erao", "erap", "eraq", "erar", "eras")
    ERAO_FIELD_NUMBER: _ClassVar[int]
    ERAP_FIELD_NUMBER: _ClassVar[int]
    ERAQ_FIELD_NUMBER: _ClassVar[int]
    ERAR_FIELD_NUMBER: _ClassVar[int]
    ERAS_FIELD_NUMBER: _ClassVar[int]
    erao: int
    erap: Gender
    eraq: _containers.RepeatedScalarFieldContainer[int]
    erar: int
    eras: str
    def __init__(self, erao: _Optional[int] = ..., erap: _Optional[_Union[Gender, str]] = ..., eraq: _Optional[_Iterable[int]] = ..., erar: _Optional[int] = ..., eras: _Optional[str] = ...) -> None: ...

class ldc(_message.Message):
    __slots__ = ("eraw", "erax", "eray", "eraz")
    ERAW_FIELD_NUMBER: _ClassVar[int]
    ERAX_FIELD_NUMBER: _ClassVar[int]
    ERAY_FIELD_NUMBER: _ClassVar[int]
    ERAZ_FIELD_NUMBER: _ClassVar[int]
    eraw: str
    erax: int
    eray: Gender
    eraz: EntityLook
    def __init__(self, eraw: _Optional[str] = ..., erax: _Optional[int] = ..., eray: _Optional[_Union[Gender, str]] = ..., eraz: _Optional[_Union[EntityLook, _Mapping]] = ...) -> None: ...

class ldd(_message.Message):
    __slots__ = ("erbd",)
    ERBD_FIELD_NUMBER: _ClassVar[int]
    erbd: str
    def __init__(self, erbd: _Optional[str] = ...) -> None: ...
...
class FightStats(_message.Message):
    __slots__ = ("damage_done", "damage_taken", "heal_done", "heal_taken", "shield_done", "shield_taken", "eseg", "eseh", "esei", "esej")
    ...
    ESEI_FIELD_NUMBER: _ClassVar[int]
    ...
    eseg: FightStats.wwt
    eseh: FightStats.wwt
    esei: FightStats.Kill
    esej: wwr
    def __init__(self, damage_done: _Optional[_Union[FightStats.DamageDone, _Mapping]] = ..., damage_taken: _Optional[_Union[FightStats.DamageTaken, _Mapping]] = ..., heal_done: _Optional[_Union[FightStats.HealDone, _Mapping]] = ..., heal_taken: _Optional[_Union[FightStats.HealTaken, _Mapping]] = ..., shield_done: _Optional[_Union[FightStats.ShieldDone, _Mapping]] = ..., shield_taken: _Optional[_Union[FightStats.ShieldTaken, _Mapping]] = ..., eseg: _Optional[_Union[FightStats.wwt, _Mapping]] = ..., eseh: _Optional[_Union[FightStats.wwt, _Mapping]] = ..., esei: _Optional[_Union[FightStats.Kill, _Mapping]] = ..., esej: _Optional[_Union[wwr, _Mapping]] = ...) -> None: ...
