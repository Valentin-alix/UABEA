...
class CharacterPresetInfo(_message.Message):
    ...
    equipment_by_position: _containers.MessageMap[int, Equipment]
    spell_preset: SpellPreset
    characteristics_info: CharacteristicsInfo
    preset_look: PresetLook
    ride: Ride
    outfit_uuid: str
    def __init__(self, uuid: _Optional[str] = ..., name: _Optional[str] = ..., symbol_id: _Optional[int] = ..., is_favorite: bool = ..., last_modification_date: _Optional[str] = ..., equipment_by_position: _Optional[_Mapping[int, Equipment]] = ..., spell_preset: _Optional[_Union[SpellPreset, _Mapping]] = ..., characteristics_info: _Optional[_Union[CharacteristicsInfo, _Mapping]] = ..., preset_look: _Optional[_Union[PresetLook, _Mapping]] = ..., ride: _Optional[_Union[Ride, _Mapping]] = ..., outfit_uuid: _Optional[str] = ...) -> None: ...
...
class ForgettableSpellPresetInfo(_message.Message):
    ...
    last_modification_date: str
    spell_preset: SpellPreset
    forgettable_spell_info_by_id: _containers.MessageMap[int, ForgettableSpellInfo]
    def __init__(self, uuid: _Optional[str] = ..., name: _Optional[str] = ..., symbol_id: _Optional[int] = ..., is_favorite: bool = ..., last_modification_date: _Optional[str] = ..., spell_preset: _Optional[_Union[SpellPreset, _Mapping]] = ..., forgettable_spell_info_by_id: _Optional[_Mapping[int, ForgettableSpellInfo]] = ...) -> None: ...
...
class CharacteristicsInfo(_message.Message):
    ...
    class CharacteristicsDetails(_message.Message):
        __slots__ = ("from_base", "from_allocated", "from_equipment", "from_bonus", "from_initial_bonus", "limit")
        ...
        limit: int
        def __init__(self, from_base: _Optional[int] = ..., from_allocated: _Optional[int] = ..., from_equipment: _Optional[int] = ..., from_bonus: _Optional[int] = ..., from_initial_bonus: _Optional[int] = ..., limit: _Optional[int] = ...) -> None: ...
    CHARACTERISTIC_DETAILS_BY_ID_FIELD_NUMBER: _ClassVar[int]
    characteristic_details_by_id: _containers.MessageMap[int, CharacteristicsInfo.CharacteristicsDetails]
    def __init__(self, characteristic_details_by_id: _Optional[_Mapping[int, CharacteristicsInfo.CharacteristicsDetails]] = ...) -> None: ...

class Equipment(_message.Message):
    __slots__ = ("gid", "effects", "uid")
    ...
    uid: int
    def __init__(self, gid: _Optional[int] = ..., effects: _Optional[_Iterable[_Union[_common_pb2.ObjectEffect, _Mapping]]] = ..., uid: _Optional[int] = ...) -> None: ...
...
class SpellPreset(_message.Message):
    ...
    spell_positions_by_id: _containers.MessageMap[int, SpellPositions]
    def __init__(self, spell_positions_by_id: _Optional[_Mapping[int, SpellPositions]] = ...) -> None: ...
...
class PresetStatUpdateRequest(_message.Message):
    ...
    preset_uuid: str
    stat_by_id: _containers.ScalarMap[int, int]
    def __init__(self, preset_uuid: _Optional[str] = ..., stat_by_id: _Optional[_Mapping[int, int]] = ...) -> None: ...
...
class PresetItemUpdateEvent(_message.Message):
    ...
    ITEM_UID_FIELD_NUMBER: _ClassVar[int]
    is_linked: bool
    item_position_by_preset_uuid: _containers.ScalarMap[str, int]
    item_uid: int
    def __init__(self, is_linked: bool = ..., item_position_by_preset_uuid: _Optional[_Mapping[str, int]] = ..., item_uid: _Optional[int] = ...) -> None: ...
...
class PresetListEvent(_message.Message):
    ...
    character_preset_info_by_id: _containers.MessageMap[str, CharacterPresetInfo]
    forgettable_spell_preset_info_by_id: _containers.MessageMap[str, ForgettableSpellPresetInfo]
    def __init__(self, character_preset_info_by_id: _Optional[_Mapping[str, CharacterPresetInfo]] = ..., forgettable_spell_preset_info_by_id: _Optional[_Mapping[str, ForgettableSpellPresetInfo]] = ...) -> None: ...
