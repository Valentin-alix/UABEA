...
class TaxCollectorDialogQuestionEvent(_message.Message):
    __slots__ = ("alliance_information", "max_pods", "prospecting", "tax_collectors_count", "looted_pods", "looted_items_value", "possible_attack")
    ...
    possible_attack: int
    def __init__(self, alliance_information: _Optional[_Union[_common_pb2.AllianceInformation, _Mapping]] = ..., max_pods: _Optional[int] = ..., prospecting: _Optional[int] = ..., tax_collectors_count: _Optional[int] = ..., looted_pods: _Optional[int] = ..., looted_items_value: _Optional[int] = ..., possible_attack: _Optional[int] = ...) -> None: ...
