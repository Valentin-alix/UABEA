...
class WhoIsEvent(_message.Message):
    __slots__ = ("self", "position", "account_name", "account_tag", "account_id", "character_name", "character_id", "area_id", "server_id", "origin_server_id", "verbose", "state", "guild_information", "alliance_information")
    ...
    def __init__(self, self_: bool = ..., position: _Optional[_Union[_common_pb2.Hierarchy, str]] = ..., account_name: _Optional[str] = ..., account_tag: _Optional[str] = ..., account_id: _Optional[int] = ..., character_name: _Optional[str] = ..., character_id: _Optional[int] = ..., area_id: _Optional[int] = ..., server_id: _Optional[int] = ..., origin_server_id: _Optional[int] = ..., verbose: bool = ..., state: _Optional[_Union[_common_pb2.CharacterState, str]] = ..., guild_information: _Optional[_Union[_common_pb2.GuildInformation, _Mapping]] = ..., alliance_information: _Optional[_Union[_common_pb2.AllianceInformation, _Mapping]] = ...) -> None: ...
