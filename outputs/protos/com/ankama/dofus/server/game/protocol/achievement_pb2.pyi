...
class AchievedAchievement(_message.Message):
    __slots__ = ("achievement_id", "achieved_by", "finished_level", "pioneer_rank")
    ACHIEVEMENT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    finished_level: int
    pioneer_rank: int
    def __init__(self, achievement_id: _Optional[int] = ..., achieved_by: _Optional[int] = ..., finished_level: _Optional[int] = ..., pioneer_rank: _Optional[int] = ...) -> None: ...
